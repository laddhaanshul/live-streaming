...
public class StartAsAudienceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_startasaudience);
    ...
    public void forwardToLiveRoom(int cRole) {
        ...
        if (!TextUtils.isEmpty(roomN)) {
            if (!TextUtils.isEmpty(name)) {
                Intent i = new Intent(StartAsAudienceActivity.this, LiveStreamActivity.class);
